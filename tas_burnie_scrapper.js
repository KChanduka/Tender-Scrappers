...
async function TAS_Burnie(){
    ...
    try {
        ...
        const url ='https://portal.tenderlink.com/burnie/login?ReturnUrl=%2Fburnie';
...
try {
    ...
    throw error;
        ...
        await page1.goBack();
            ...
            reArrangeTheOldAndNewData(scrapedData, "tas-brn-");
        await browser.close()
