...
const pwd = "r3W<5256|,bM"; 

async function NSW_GreaterHume(){
    ...
    try {
        ...
        //goto the registration page
            await page1.goto('https://portal.tenderlink.com/greaterhume/login?ReturnUrl=%2Fgreaterhume');
