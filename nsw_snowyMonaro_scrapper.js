...
async function NSW_SnowyMonaro(){
...
try{    
    ...
    await page1.goto('https://www.vendorpanel.com.au/publictenders.aspx?emcc=501D3294B69A');
       ...
       for(const elm of links ){
            ...
            //extracting data
                ...
                //region
                    ...
                    const region = ["Snowy Monaro Regional Council"];
...
NSW_SnowyMonaro();
module.exports = NSW_SnowyMonaro;