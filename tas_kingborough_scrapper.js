...
async function TAS_Kingborough(){
    ...
    try {
        ...
        const url ='https://portal.tenderlink.com/kc/login?ReturnUrl=%2Fkc%2F';
...
try {
    ...
    throw error;
        ...
        await page1.goBack();
            ...
            reArrangeTheOldAndNewData(scrapedData, "tas-knb-");
        await browser.close()
...
TAS_Kingborough(); 
module.exports = TAS_Kingborough;
