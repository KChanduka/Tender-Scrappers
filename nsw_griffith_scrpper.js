...
const pwd = "0Z0v7&XxX@M^"; 

async function NSW_Griffith(){
    ...
    try {
        ...
        //goto the registration page
            await page1.goto('https://portal.tenderlink.com/griffith/login?ReturnUrl=%2Fgriffith');
