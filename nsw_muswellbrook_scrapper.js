...
async function NSW_Muswellbrook(){
...
try{    
    ...
    await page1.goto('https://www.vendorpanel.com.au/PublicTenders.aspx?profileGroupId=6798');
       ...
       for(const elm of links ){
            ...
            //extracting data
                ...
                //region
                    ...
                    const region = ["Broken Hill City Council"];
                ...
                // reArrangeTheOldAndNewData(scrapedData, "nsw-msb-");
                await page2.close();
...
NSW_Muswellbrook();
module.exports = NSW_Muswellbrook;