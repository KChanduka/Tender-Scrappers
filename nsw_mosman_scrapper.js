...
const pwd = "807b~C.,{kad"; 

async function NSW_Mosman(){
    ...
    try {
        ...
        //goto the registration page
            await page1.goto('https://portal.tenderlink.com/mosman/login?ReturnUrl=%2Fmosman');
        ...
        for(let i = 0; i<numOfLinks ; i++){
                ...
                tempObj =  {
                    ...
                    location: ["NSW"],
                    region: ["Mosman Municipal Council"],
