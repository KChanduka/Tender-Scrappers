...
try{    
    ...
    await page1.goto('https://www.vendorpanel.com.au/PublicTenders.aspx?emcc=51DC0B62BC57');
       ...
       for(const elm of links ){
            ...
            //extracting data
                ...
                //region
                    ...
                    const region = ["Bogan Shire Council"];
                ...
                // reArrangeTheOldAndNewData(scrapedData, "nsw-bgn-");
                await page2.close();
