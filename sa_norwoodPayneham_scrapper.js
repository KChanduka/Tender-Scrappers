...
async function SA_NorwoodPaynehamAndStPteters() {
  try {
    ...
    const pageUrls = [
      "https://www.tenders.sa.gov.au/tender/search?keywords=&tenderCode=&tenderState=OPEN&tenderType=&issuingBusinessId=80438&awardedSupplier.id=&awardedSupplier.name=&openThisWeek=false&openingDateFrom=&openingDateTo=&closeThisWeek=false&closingDateFrom=&closingDateTo=&groupBy=NONE&page=&searchTitle=",
    ];
    ...
    for (const dataItem of allData) {
      ...
      const location = ["SA"];
      const region = ["City of Norwood Payneham & St Peters"];
    ...
    await reArrangeTheOldAndNewData(tenderData, "sa-npp-");
...
SA_NorwoodPaynehamAndStPteters();
module.exports = SA_NorwoodPaynehamAndStPteters;
