...
const pwd = "qm4P>2Jsr*N~7W7"; 

async function NSW_Eurobodalla(){
    ...
    try {
        ...
        //goto the registration page
            await page1.goto('https://portal.tenderlink.com/eurobodalla/login?ReturnUrl=%2Feurobodalla');
        ...
        for(let i = 0; i<numOfLinks ; i++){
                ...
                tempObj =  {
                    ...
                    location: ["NSW"],
                    region: ["Eurobodalla Shire Council"],
