...
async function SA_PortAugusta() {
  try {
    ...
    const pageUrls = [
      "https://www.tenders.sa.gov.au/tender/search?keywords=&tenderCode=&tenderState=OPEN&tenderType=&categories%5B0%5D.fullTitle=&categories%5B0%5D.id=&issuingBusinessId=79161&openThisWeek=false&openingDateFrom=&openingDateTo=&closeThisWeek=false&closingDateFrom=&closingDateTo=&groupBy=NONE&page=&searchTitle=",
    ];
    ...
    for (const dataItem of allData) {
      ...
      const location = ["SA"];
      const region = ["City of Port Augusta"];
