...
async function QLD_ChartersTowers(){
...
try{    
    ...
    await page1.goto('https://www.vendorpanel.com.au/PublicTenders.aspx?profileGroupId=6018');
       ...
       for(const elm of links ){
            ...
            //extracting data
                ...
                //region
                    ...
                    const region = ["Chartes Towers Region"];
