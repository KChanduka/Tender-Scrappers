...
async function TAS_Hobart(){
    ...
    try {
        ...
        const url ='https://portal.tenderlink.com/hobartcitycouncil/login?ReturnUrl=%2Fhobartcitycouncil%2FHome';
...
try {
    ...
    throw error;
        ...
        await page1.goBack();
            ...
            // reArrangeTheOldAndNewData(scrapedData, "tas-hbt-");
        await browser.close()
