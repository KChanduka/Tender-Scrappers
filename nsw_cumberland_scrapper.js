...
async function NSW_Cumberland(){
    ...
    try {
        ...
        //login
        await page1.goto("https://app.eprocure.com.au/cumberland/login");
        await page1.waitForSelector('form');
        await page1.type(" form > div:nth-child(1) > div > input",email.main1,{delay:150});
        await page1.type("#show_hide_password > input",pwd.cumberland,{delay:150});
        //tick the checkbox
        ...
        if (linkCount.length > 0) {
            ...
            for(let i = 0 ; i < linkCount.length; i++){
                ...
                scrapedData.push({
                    ...
                    location: ["NSW"],
                    region: ["Cumberland City Council"],
