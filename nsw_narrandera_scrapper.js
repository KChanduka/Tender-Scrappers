...
try{    
    ...
    await page1.goto('https://www.vendorpanel.com.au/PublicTenders.aspx?profileGroupId=6087');
       ...
       for(const elm of links ){
            ...
            //extracting data
                ...
                // reArrangeTheOldAndNewData(scrapedData, "nsw-nrd-");
                await page2.close();
