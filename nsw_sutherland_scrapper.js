...
try{    
    ...
    await page1.goto('https://www.vendorpanel.com.au/PublicTenders.aspx?profileGroupId=862');
       ...
       for(const elm of links ){
            ...
            //extracting data
                ...
                //region
                    ...
                    const region = ["Sutherland Shire Council"];
                ...
                // reArrangeTheOldAndNewData(scrapedData, "nsw-stl-");
                await page2.close();
