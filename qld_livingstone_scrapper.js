...
async function QLD_Livingstone(){
...
try{    
    ...
    await page1.goto('https://www.vendorpanel.com.au/PublicTenders.aspx?profileGroupId=1355');
       ...
       for(const elm of links ){
            ...
            //extracting data
                ...
                //region
                    ...
                    const region = ["Livingstone Shire Council"];
