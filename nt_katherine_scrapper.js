...
async function NT_Katherine(){
    ...
    try {
        ...
        const url ='https://portal.tenderlink.com/ktc/login?ReturnUrl=%2Fktc';
...
try {
    ...
    throw error;
        ...
        await page1.goBack();
            ...
            reArrangeTheOldAndNewData(scrapedData, "nt-ktn-");
        await browser.close()
