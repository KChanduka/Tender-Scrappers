...
try{    
    ...
    await page1.goto('https://www.vendorpanel.com.au/PublicTenders.aspx?profileGroupId=3671');
       ...
       for(const elm of links ){
            ...
            //extracting data
                ...
                //region
                    ...
                    const region = ["Moree Plains Shire Council"];
                ...
                // reArrangeTheOldAndNewData(scrapedData, "nsw-mor-");
                await page2.close();
