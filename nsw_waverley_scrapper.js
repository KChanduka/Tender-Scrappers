...
try{    
    ...
    await page1.goto('https://www.vendorpanel.com.au/PublicTenders.aspx?profileGroupId=1138');
            ...
            //extracting data
                ...
                title =  await page2.evaluate(()=>{
                        ...
                        if(titleELement){
                            ...
                            const match = titleELement.match(/^[A-Za-z]+\s+\d+\s+/);    
