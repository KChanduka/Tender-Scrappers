...
async function VIC_Yarra(){
    ...
    try {
        ...
        //login
        await page1.goto("https://app.eprocure.com.au/yarracity/login");
        await page1.waitForSelector('form');
        await page1.type(" form > div:nth-child(1) > div > input",email.main1,{delay:150});
        await page1.type("#show_hide_password > input",pwd.yarra,{delay:150});
        //tick the checkbox
