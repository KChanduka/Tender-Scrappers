...
async function sa_scrapeData() {
  try {
    ...
    for (const pageUrl of pageUrls) {
      ...
      await page.waitForSelector("#resultDiv > div.tender-table > div");
    ...
    await reArrangeTheOldAndNewData(tenderData, "sa-");
  } catch (error) {
    console.log(error);
  }
}
