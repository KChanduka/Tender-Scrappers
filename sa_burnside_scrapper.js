...
async function SA_Burnside() {
  try {
    ...
    const pageUrls = [
      "https://www.tenders.sa.gov.au/tender/search?keywords=&tenderCode=&tenderState=OPEN&tenderType=&issuingBusinessId=79531&awardedSupplier.id=&awardedSupplier.name=&openThisWeek=false&openingDateFrom=&openingDateTo=&closeThisWeek=false&closingDateFrom=&closingDateTo=&groupBy=NONE&page=&searchTitle=",
    ];
