...
async function VIC_GreaterGeelong(){
    ...
    try {
        ...
        //login
        await page1.goto("https://app.eprocure.com.au/geelong/login");
        await page1.waitForSelector('form');
        await page1.type(" form > div:nth-child(1) > div > input",email.main1,{delay:150});
        await page1.type("#show_hide_password > input",pwd.greaterGeelong,{delay:150});
        //tick the checkbox
        ...
        if (linkCount.length > 0) {
            ...
            for(let i = 0 ; i < linkCount.length; i++){
                ...
                scrapedData.push({
                    ...
                    location: ["VIC"],
                    region: ["City of Greater Geelong"],
...
VIC_GreaterGeelong();
module.exports = VIC_GreaterGeelong;