...
try{    
    ...
    await page1.goto('https://www.vendorpanel.com.au/PublicTenders.aspx?profileGroupId=5943');
       ...
       for(const elm of links ){
            ...
            //extracting data
                ...
                // reArrangeTheOldAndNewData(scrapedData, "nsw-wal-");
                await page2.close();
