...
async function SA_Barossa() {
  try {
    ...
    const pageUrls = [
      "https://www.tenders.sa.gov.au/tender/search?keywords=&tenderCode=&tenderState=OPEN&tenderType=&issuingBusinessId=141087&awardedSupplier.id=&awardedSupplier.name=&openThisWeek=false&openingDateFrom=&openingDateTo=&closeThisWeek=false&closingDateFrom=&closingDateTo=&groupBy=NONE&page=&searchTitle=",
    ];
    ...
    await reArrangeTheOldAndNewData(tenderData, "sa-brs-");
