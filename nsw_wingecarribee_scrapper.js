            ...
            //extracting data
                ...
                title = await page2.evaluate(() => {
                    ...
                    if (titleElement) {
                        ...
                        const match = titleElement.match(/\s*-\s*RFT\s*T-\d{4}-\d{2}$/);
                ...
                //region
                    ...
                    const region = ["Wingecarribee Shire Council"];
