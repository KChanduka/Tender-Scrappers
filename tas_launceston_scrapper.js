...
async function TAS_Launceston(){
    ...
    try {
        ...
        const url ='https://portal.tenderlink.com/launceston/login?ReturnUrl=%2Flaunceston';
...
try {
    ...
    throw error;
        ...
        await page1.goBack();
            ...
            reArrangeTheOldAndNewData(scrapedData, "tas-lct-");
        await browser.close()
