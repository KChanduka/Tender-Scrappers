...
async function NSW_QueanbeyanPalerang(){
...
try{    
    ...
    await page1.goto('https://www.vendorpanel.com.au/PublicTenders.aspx?profileGroupId=3672');
       ...
       for(const elm of links ){
            ...
            //extracting data
                ...
                //region
                    ...
                    const region = ["Queanbeyan-Palerang Regional Council"];
                ...
                // reArrangeTheOldAndNewData(scrapedData, "nsw-qbp-");
                await page2.close();
...
NSW_QueanbeyanPalerang();
module.exports = NSW_QueanbeyanPalerang;