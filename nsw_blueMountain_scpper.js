...
async function NSW_BlueMountain(){
    ...
    try{   
        ...
        await page1.goto('https://www.vendorpanel.com.au/PublicTenders.aspx?mode=all&emcc=8450A8CC7090');
           ...
           for(const elm of links ){
                ...
                //extracting data
                    ...
                    //region
                        ...
                        const region = ["Blue Mountain City Council"];
