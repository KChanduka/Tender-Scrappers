...
const pwd = "Z6y17^e$hJYV"; 

async function NSW_Parramatta(){
    ...
    try {
        ...
        //goto the registration page
            await page1.goto('https://portal.tenderlink.com/parracity/login?ReturnUrl=%2Fparracity');
        ...
        for(let i = 0; i<numOfLinks ; i++){
                ...
                tempObj =  {
                    ...
                    location: ["NSW"],
                    region: ["City of Parramatta Council"],
