...
const pwd = "{03uX8nPLWwE"; 

async function NSW_Brewarrina(){
    ...
    try {
        ...
        //goto the registration page
            await page1.goto('https://portal.tenderlink.com/brewarrina/login?ReturnUrl=%2Fbrewarrina');
        ...
        for(let i = 0; i<numOfLinks ; i++){
                ...
                tempObj =  {
                    ...
                    location: ["NSW"],
                    region: ["Brewarrina Shire Council"],
