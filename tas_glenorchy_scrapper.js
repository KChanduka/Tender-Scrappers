...
async function TAS_Glenorchy(){
    ...
    try {
        ...
        const url ='https://portal.tenderlink.com/gcc/login?ReturnUrl=%2Fgcc';
...
try {
    ...
    throw error;
        ...
        await page1.goBack();
            ...
            // reArrangeTheOldAndNewData(scrapedData, "tas-gln-");
        await browser.close()
