...
async function VIC_GreaterShepparton(){
    ...
    try {
        ...
        //login
        await page1.goto("https://app.eprocure.com.au/greatershepparton/login");
        await page1.waitForSelector('form');
        await page1.type(" form > div:nth-child(1) > div > input",email.main1,{delay:150});
        await page1.type("#show_hide_password > input",pwd.greaterSheparton,{delay:150});
        //tick the checkbox
        ...
        if (linkCount.length > 0) {
            ...
            for(let i = 0 ; i < linkCount.length; i++){
                ...
                scrapedData.push({
                    ...
                    location: ["VIC"],
                    region: ["Greater Shepparton City Council"],
        ...
        console.log(scrapedData);
        // await reArrangeTheOldAndNewData(tenderData, "vic-ggl-");
        await browser.close();
...
VIC_GreaterShepparton();
module.exports = VIC_GreaterShepparton;