...
async function QLD_Cairns(){
    ...
    try {
        ...
        const url ='https://portal.tenderlink.com/cairns/login?ReturnUrl=%2Fcairns';
    ...
    console.log(error);
        ...
        for(let i = 0; i<numOfLinks ; i++){
                ...
                tempObj =  {
                    ...
                    location: ["QLD"],
                    region: ["Cairns Regional Council"],
...
try {
    ...
    throw error;
        ...
        await page1.goBack();
            ...
            reArrangeTheOldAndNewData(scrapedData, "qld-cns-");
        await browser.close()
