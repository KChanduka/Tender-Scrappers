...
async function WA_VictoriaPark(){
    ...
    try {
        ...
        const url ='https://portal.tenderlink.com/vicpark/login?ReturnUrl=%2Fvicpark';
...
WA_VictoriaPark(); 
module.exports = WA_VictoriaPark;
