...
async function VIC_PortPhillip(){
    ...
    try {
        ...
        const url ='https://portal.tenderlink.com/portphillip/login?ReturnUrl=%2Fportphillip%2F';
...
try {
    ...
    throw error;
        ...
        await page1.goBack();
            ...
            // reArrangeTheOldAndNewData(scrapedData, "vic-mlb-");
        await browser.close()
...
VIC_PortPhillip(); 
module.exports = VIC_PortPhillip;
