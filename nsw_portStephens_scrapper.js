...
async function NSW_PortStephens(){
    ...
    try {
        ...
        //login
        await page1.goto("https://app.eprocure.com.au/portstephens/login");
        await page1.waitForSelector('form');
        await page1.type(" form > div:nth-child(1) > div > input",email.main1,{delay:150});
        await page1.type("#show_hide_password > input",pwd.portStephens,{delay:150});
