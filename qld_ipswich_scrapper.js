...
try{    
    ...
    await page1.goto('https://www.vendorpanel.com.au/PublicTenders.aspx?mode=all&g=000000000000&profileGroupId=3656');
       ...
       for(const elm of links ){
            ...
            //extracting data
                ...
                reArrangeTheOldAndNewData(scrapedData, "qld-ipw-");
                await page2.close();
