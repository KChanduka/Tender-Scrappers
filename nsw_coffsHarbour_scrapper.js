...
const pwd = "8Fr1a$#R5)>1"; 

async function NSW_CoffsHarbour(){
    ...
    try {
        ...
        //goto the registration page
            await page1.goto('https://portal.tenderlink.com/coffsharbour/login?ReturnUrl=%2Fcoffsharbour');
        ...
        for(let i = 0; i<numOfLinks ; i++){
                ...
                tempObj =  {
                    ...
                    location: ["NSW"],
                    region: ["Coffs Harbour City Council"],
