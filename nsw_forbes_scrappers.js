...
const pwd = "gF30<8^66zcZ"; 

async function NSW_Forbes(){
    ...
    try {
        ...
        //goto the registration page
            await page1.goto('https://portal.tenderlink.com/forbes/login?ReturnUrl=%2Fforbes');
