...
async function NSW_Tenterfield(){
    ...
    try {
        ...
        //goto the registration page
            await page1.goto('https://portal.tenderlink.com/tenterfield/login?ReturnUrl=%2Ftenterfield%2F');
        ...
        for(let i = 0; i<numOfLinks ; i++){
                ...
                tempObj =  {
                    ...
                    location: ["NSW"],
                    region: ["Tenterfield Shire Council"],
