...
const pwd = "04Nf1Cx_`r)b"; 

async function NSW_Dungog(){
    ...
    try {
        ...
        //goto the registration page
            await page1.goto('https://portal.tenderlink.com/dungog/login?ReturnUrl=%2Fdungog');
