...
async function NSW_Nambucco(){

    const browser = await puppeteer.launch();
    try{    
        const page1 = await browser.newPage();

        await page1.goto('https://www.vendorpanel.com.au/PublicTenders.aspx?emcc=84C9C52185D6&mode=all');
           ...
           for(const elm of links ){
                ...
                //extracting data
                    ...
                    //region
                        ...
                        const region = ["Nambucco Shire Council"];
